...
import os, sys, time
import queue
from PyQt5.QtCore import QSize, QRectF, QTimer
from PyQt5.QtGui import QPalette, QPainter, QColor, QPen
from PyQt5.QtWidgets import QWidget, QSizePolicy, QTextBrowser, QMainWindow, QPushButton, QHBoxLayout, QApplication

from eliben.working.socketclientthread import SocketClientThread, ClientCommand, ClientReply
...
class LogWidget(QTextBrowser):
    def __init__(self, parent=None):
        ...
        palette = QPalette()
        palette.setColor(QPalette.Base, QColor("#b4c5e4"))
